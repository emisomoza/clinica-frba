...
namespace ClinicaFrba.Registro_Llegada
{
    public partial class Registrar_Llegada : Form
    {
        ...
        public Registrar_Llegada()
        {
            ...
            String query = "SELECT 0 as id_especialidad, 'Seleccionar especialidad' as descripcion UNION SELECT ID_ESPECIALIDAD, DESCRIPCION FROM [" + Settings.Default.SQL_Schema + "].[ESPECIALIDAD];";
