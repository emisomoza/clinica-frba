...
namespace ClinicaFrba.Listados
{
    ...
    {
        int anio;
        public Especialidades_Mas_Bonos(int anio)
        {
            InitializeComponent();
            this.anio = anio;
        }

        private void Especialidades_Mas_Bonos_Load(object sender, EventArgs e)
        {
        ...
        {
            SQL sql = new SQL();
            String query = "SELECT * FROM [" + Settings.Default.SQL_Schema + "].fn_estad_espec_con_mas_bonos (" +
                            this.anio + ", " +
